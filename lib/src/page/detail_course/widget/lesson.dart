                ...
                children: [
                  SingleChildScrollView(
                    ...
                    child: Column(
                      crossAxisAlignment: CrossAxisAlignment.start,
                      children:
                          List.generate(widget.provider.listData[index].getCourseDataVideo?.length ?? 10, (index) {
                        final check = list.getCourseDataVideo?[index].videoUrl?.isEmpty;
                          ...
                          onTap: !(check ?? true)
                              ? () {
                                  Navigator.push(context, MaterialPageRoute(
                                    builder: (context) {
                                      return VideoPage(
                                        url: list.getCourseDataVideo?[index].videoUrl ?? '',
                                        idCourse: list.id ?? '',
                                        idVideo: list.getCourseDataVideo?[index].id ?? '',
                                      );
                                    },
                                  ));
                                }
                            ...
                            child: Row(
                              children: [
                                ...
                                Column(
                                  ...
                                  children: [
                                    Text(
                                      list.getCourseDataVideo?[index].videoTitle ?? '',
                                      style: const TextStyle(
                                    ...
                                    Text(
                                      (widget.provider.convertMillisecondsToSeconds(
                                              list.getCourseDataVideo?[index].videoLength ?? 0))
                                          .toString(),
                                      style: const TextStyle(
